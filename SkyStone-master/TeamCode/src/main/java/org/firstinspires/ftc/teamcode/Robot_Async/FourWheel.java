...
public class FourWheel
{
    ...
    public void RunFourWheels(DcMotor motor1, DcMotor motor2, DcMotor motor3, DcMotor motor4)
    {
        ...
        new Thread(new EncoderClass_Async(encoderWatch1, motor1, EncoderClass.MotorType.NeveRest40, 37, 0.5, true)).start();
