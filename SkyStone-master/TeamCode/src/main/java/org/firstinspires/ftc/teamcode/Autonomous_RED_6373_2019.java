...
@Autonomous(name = "Autonomous_RED_6373_2019", group = "Autonomous")
public class Autonomous_RED_6373_2019 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (new Date().getTime() - startTime < 750) //run motors for 1 second
        {
        ...
        while (new Date().getTime() - startTime < 2200) //run motors for 1 second
        {
            telemetry.addData("Loop", 1);
            telemetry.update();
            //EncoderClass.RunToEncoderDegreeAsync(FL, EncoderClass.MotorType.NeveRest40, 1800, 1.0, false);
